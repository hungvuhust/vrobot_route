...
public:
   ...
   */
  std::pair<std::vector<PathSegment>, std::optional<double>> dijkstra(
    const v_node_t &start_node,
   ...
   * @return Pair of (path_segments, total_distance)
   */
  std::pair<std::vector<PathSegment>, std::optional<double>> dijkstra_from_pose(
...
protected:
   ...
   */
  double calculate_path_distance(
    const std::vector<PathSegment> &path_segments) const;
