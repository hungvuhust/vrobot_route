...
v_node_t GeometricUtils::get_nearest_node(const Eigen::Vector2d &query_pose) {
...
GeometricUtils::get_closest_links(const Eigen::Vector2d &query_pose,
                                  int max_links, double max_distance) {
...
double
GeometricUtils::get_distance_to_line_segment(const Eigen::Vector2d &point,
